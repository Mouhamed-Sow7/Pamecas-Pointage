      ...
      <div id="dashboard-content" style="display:none;">
        <div class="kpi-grid">
          <div class="kpi-card">
            ...
            <div id="kpi-present" class="kpi-value" style="color:#2E7D32;">0</div>
          </div>
          <div class="kpi-card">
            <div class="kpi-label">Absents</div>
            <div id="kpi-absent" class="kpi-value" style="color:#E53935;">0</div>
          </div>
          <div class="kpi-card">
            <div class="kpi-label">Retards</div>
            <div id="kpi-retard" class="kpi-value" style="color:#FB8C00;">0</div>
          </div>
          <div class="kpi-card">
            <div class="kpi-label">Taux de présence</div>
            <div id="kpi-taux" class="kpi-value" style="color:#1976D2;">0%</div>
          </div>
        </div>
        <div class="card">
