  ...
  <div style="max-width:640px;margin:32px auto;background:white;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
    ...
    <div style="display:grid;grid-template-columns:repeat(4,1fr);border-bottom:1px solid #eee;">
      <div style="padding:20px 16px;text-align:center;border-right:1px solid #eee;">
        <div style="font-size:0.72rem;color:#888;margin-bottom:6px;text-transform:uppercase;">Total</div>
        <div style="font-size:1.8rem;font-weight:700;color:#1f2933;">${totalPointages}</div>
      </div>
      <div style="padding:20px 16px;text-align:center;border-right:1px solid #eee;">
        <div style="font-size:0.72rem;color:#888;margin-bottom:6px;text-transform:uppercase;">Presents</div>
        <div style="font-size:1.8rem;font-weight:700;color:#2e7d32;">${totalPresents}</div>
      </div>
      <div style="padding:20px 16px;text-align:center;border-right:1px solid #eee;">
        <div style="font-size:0.72rem;color:#888;margin-bottom:6px;text-transform:uppercase;">Absents</div>
        <div style="font-size:1.8rem;font-weight:700;color:#c62828;">${totalAbsents}</div>
      </div>
      <div style="padding:20px 16px;text-align:center;">
        <div style="font-size:0.72rem;color:#888;margin-bottom:6px;text-transform:uppercase;">Taux</div>
