...
const agentsParAgence = {
  'CMS-DG': [
    { matricule: 'CMS-DG-001', prenom: 'Mamadou', nom: 'Diallo', poste: 'Directeur General' },
    { matricule: 'CMS-DG-002', prenom: 'Aissatou', nom: 'Sow', poste: 'Secrétaire DG' },
    { matricule: 'CMS-DG-003', prenom: 'Cheikh', nom: 'Mbaye', poste: 'Comptable Chef' },
    { matricule: 'CMS-DG-004', prenom: 'Fatou', nom: 'Diop', poste: 'Chargée RH' },
    { matricule: 'CMS-DG-005', prenom: 'Ibrahima', nom: 'Fall', poste: 'Responsable IT' },
    { matricule: 'CMS-DG-006', prenom: 'Rokhaya', nom: 'Ndiaye', poste: 'Assistante Direction' },
    { matricule: 'CMS-DG-007', prenom: 'Modou', nom: 'Sarr', poste: 'Chauffeur' },
    { matricule: 'CMS-DG-008', prenom: 'Astou', nom: 'Cissé', poste: 'Agent de sécurité' },
  ],
  'CMS-GRAND-YOFF': [
    { matricule: 'CMS-GY-001', prenom: 'Ousmane', nom: 'Diouf', poste: 'Chef Agence' },
    { matricule: 'CMS-GY-002', prenom: 'Mariama', nom: 'Ba', poste: 'Caissière' },
    { matricule: 'CMS-GY-003', prenom: 'Abdou', nom: 'Niang', poste: 'Agent de Crédit' },
    { matricule: 'CMS-GY-004', prenom: 'Seynabou', nom: 'Gaye', poste: 'Caissière' },
    { matricule: 'CMS-GY-005', prenom: 'Lamine', nom: 'Thiaw', poste: 'Gestionnaire Compte' },
    { matricule: 'CMS-GY-006', prenom: 'Ndéye', nom: 'Faye', poste: 'Agent Accueil' },
  ],
  'CMS-PIKINE': [
    { matricule: 'CMS-PK-001', prenom: 'Babacar', nom: 'Diallo', poste: 'Chef Agence' },
    { matricule: 'CMS-PK-002', prenom: 'Coumba', nom: 'Mbodj', poste: 'Caissière' },
    { matricule: 'CMS-PK-003', prenom: 'Samba', nom: 'Diagne', poste: 'Agent de Crédit' },
    { matricule: 'CMS-PK-004', prenom: 'Aminata', nom: 'Toure', poste: 'Agent Accueil' },
    { matricule: 'CMS-PK-005', prenom: 'Pape', nom: 'Gueye', poste: 'Gestionnaire Compte' },
    { matricule: 'CMS-PK-006', prenom: 'Yacine', nom: 'Wade', poste: 'Caissière' },
  ],
  'CMS-GUEDIAWAYE': [
    { matricule: 'CMS-GW-001', prenom: 'Assane', nom: 'Lo', poste: 'Chef Agence' },
    { matricule: 'CMS-GW-002', prenom: 'Khady', nom: 'Diop', poste: 'Caissière' },
    { matricule: 'CMS-GW-003', prenom: 'Moussa', nom: 'Ndour', poste: 'Agent de Crédit' },
    { matricule: 'CMS-GW-004', prenom: 'Binta', nom: 'Sall', poste: 'Agent Accueil' },
    { matricule: 'CMS-GW-005', prenom: 'Thierno', nom: 'Kane', poste: 'Gestionnaire Compte' },
    { matricule: 'CMS-GW-006', prenom: 'Dieynaba', nom: 'Samb', poste: 'Caissière' },
  ],
  'CMS-THIES': [
    { matricule: 'CMS-TH-001', prenom: 'Cheikh', nom: 'Diallo', poste: 'Chef Agence' },
    { matricule: 'CMS-TH-002', prenom: 'Sokhna', nom: 'Mbaye', poste: 'Caissière' },
    { matricule: 'CMS-TH-003', prenom: 'Momar', nom: 'Ndiaye', poste: 'Agent de Crédit' },
    { matricule: 'CMS-TH-004', prenom: 'Awa', nom: 'Badji', poste: 'Agent Accueil' },
    { matricule: 'CMS-TH-005', prenom: 'Alioune', nom: 'Tine', poste: 'Gestionnaire Compte' },
    { matricule: 'CMS-TH-006', prenom: 'Rama', nom: 'Dieye', poste: 'Caissière' },
  ],
};
