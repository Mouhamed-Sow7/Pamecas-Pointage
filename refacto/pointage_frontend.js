    ...
    <div style="display:flex;flex-direction:column;gap:14px;">
      ...
      <div>
        ...
        <div style="display:flex;flex-direction:column;gap:8px;">
          <label style="display:flex;align-items:center;gap:12px;padding:11px 14px;border:1.5px solid #ddd;border-radius:10px;cursor:pointer;transition:border-color 0.15s;">
            <input type="radio" name="edit-statut" value="present" ${currentStatut==='present'?'checked':''} style="accent-color:#2e7d32;width:18px;height:18px;flex-shrink:0;">
            <span style="width:10px;height:10px;border-radius:50%;background:#2e7d32;flex-shrink:0;"></span>
            <span style="color:#2e7d32;font-weight:600;font-size:0.88rem;">Present</span>
          </label>
          <label style="display:flex;align-items:center;gap:12px;padding:11px 14px;border:1.5px solid #ddd;border-radius:10px;cursor:pointer;">
            <input type="radio" name="edit-statut" value="absent" ${currentStatut==='absent'?'checked':''} style="accent-color:#c62828;width:18px;height:18px;flex-shrink:0;">
            <span style="width:10px;height:10px;border-radius:50%;background:#c62828;flex-shrink:0;"></span>
            <span style="color:#c62828;font-weight:600;font-size:0.88rem;">Absent</span>
          </label>
          <label style="display:flex;align-items:center;gap:12px;padding:11px 14px;border:1.5px solid #ddd;border-radius:10px;cursor:pointer;">
            <input type="radio" name="edit-statut" value="retard" ${currentStatut==='retard'?'checked':''} style="accent-color:#e65100;width:18px;height:18px;flex-shrink:0;">
            <span style="width:10px;height:10px;border-radius:50%;background:#e65100;flex-shrink:0;"></span>
            <span style="color:#e65100;font-weight:600;font-size:0.88rem;">Retard</span>
          </label>
        </div>
      </div>
